function [roiPos_circle,h] = PlotRoisOnCircle(atlas,idx,groupClusters,clusterNames,marker)
...
%
% [roiPos_circle,h] = PlotRoisOnCircle(atlas,idx,groupClusters,clusterNames,marker)
%
% INPUTS:
